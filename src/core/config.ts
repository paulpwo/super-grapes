...
export function buildGrapesConfig(config: SuperGrapesConfig): Record<string, unknown> {
  ...
  const base: Record<string, unknown> = {
    ...
    forceClass: config.avoidInlineStyle ?? false,
  ...
  return [
    {
      ...
      properties: [
        ...
        { property: 'top', type: 'number', units: ['px', '%', 'em', 'rem', 'vh'], min: -1000, max: 1000 },
        { property: 'right', type: 'number', units: ['px', '%', 'em', 'rem', 'vw'], min: -1000, max: 1000 },
        { property: 'bottom', type: 'number', units: ['px', '%', 'em', 'rem', 'vh'], min: -1000, max: 1000 },
        { property: 'left', type: 'number', units: ['px', '%', 'em', 'rem', 'vw'], min: -1000, max: 1000 },
      ],
    },
    {
      name: 'Dimension',
    ...
    },
    {
      ...
      properties: [
        ...
        { property: 'flex-basis', type: 'number', units: ['px', '%', 'em', 'rem', 'auto'], defaults: 'auto', min: 0, max: 1000 },
