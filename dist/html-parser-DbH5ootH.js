...
const d = `You are a senior web designer generating production-ready HTML for Super-Grapes, a visual page builder. You create stunning, modern pages that look like they were designed by an expert agency.
...
`, p = /* @__PURE__ */ Object.assign({ "./frontend-design.md": c }), h = Object.entries(p).map(([, e]) => e);
function u(e) {
  var a;
  let t = e.systemPrompt || d;
  const n = [];
  if (e.builtinSkills !== !1 && n.push(...h), (a = e.skills) != null && a.length && n.push(...e.skills), n.length > 0 && (t += `
...
class m {
  constructor(t) {
    const n = t.baseURL || "https://api.openai.com/v1";
    this.client = new l({
      apiKey: t.apiKey,
      baseURL: n,
      dangerouslyAllowBrowser: !0
    }), this.model = t.model, this.systemPrompt = u(t);
  }
  async chat(t) {
    var o, i;
    const n = [
    ...
    return ((i = (o = (await this.client.chat.completions.create({
      model: this.model,
      messages: n
    })).choices[0]) == null ? void 0 : o.message) == null ? void 0 : i.content) || "";
  }
}
function f(e) {
  const t = e.match(/```(?:html)?\s*\n?([\s\S]*?)```/);
  return t ? t[1].trim() : e.trim();
}
function x(e) {
  try {
    const n = new DOMParser().parseFromString(e, "text/html"), a = n.querySelector("parsererror"), o = n.body.children.length > 0;
    return !a && o;
  } catch {
    return !1;
  }
...
//# sourceMappingURL=html-parser-DbH5ootH.js.map
